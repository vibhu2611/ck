...
export default function HeaderPrivacy() {
  ...
  return (
    <>
          <header className="font-family-akira" id='header2'>
                    ...
                    <Router>
                      <ul className="navbar-nav  mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                ...
                                <a className="nav-link fw-bold px-3" href="/eco">ECO-SYSTEM</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link fw-bold px-3" href="/road">ROADMAP</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link fw-bold px-3" href="/team">TEAM</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link fw-bold px-3" href="/faqpage">FAQ</a>
                            </li>
                            <li className="nav-item">
